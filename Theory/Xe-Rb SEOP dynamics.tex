...
where $T_i$ and $T_d$ are the integration and derivative times respectively. We can extract $\epsilon$ from the measurement of $\beta$ following eq.(\ref{eq:phase_leg}).  
