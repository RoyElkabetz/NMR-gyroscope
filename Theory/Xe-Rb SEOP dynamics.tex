...
In a closed-loop NMRG configuration we feedback the drive magnetic field such that $\beta$ is held constant $\beta=\beta_0$. Although, in the most general case the phase leg would be
...
\begin{align}
    ...
    \frac{d\theta}{dt} &=  \frac{d\phi}{dt} - \frac{d\epsilon}{dt}\\
    \frac{d\theta}{dt} &=  \Omega_z -\Gamma_2 \left(\beta_0 + \epsilon\left(t\right)\right) - \frac{d\epsilon}{dt}\\
    \frac{d\theta}{dt} &=  \omega_0 -\frac{\epsilon\left(t\right)}{T_2}  - \frac{d\epsilon}{dt}
\end{align}
