...
\begin{align}
    ...
    \end{array}\right)\\
    \left(\begin{array}{cc}
        \frac{M_{12}^2+\Gamma_2^2}{\Gamma_2} & -\frac{\Omega_d}{2}\\
        \frac{\Omega_d}{2} & \Gamma_1
    \end{array}\right)
    \left(\begin{array}{c}
        \tilde{K}_{y}\\
        \tilde{K}_{z} 
    ...
    \end{array}\right)\\
    \left(\begin{array}{cc}
       \left(1 + \left(M_{12}/\Gamma_2\right)^2\right)\Gamma_2 & -\frac{\Omega_d}{2}\\
        \frac{\Omega_d}{2} & \Gamma_1
    \end{array}\right)
    \left(\begin{array}{c}
        \tilde{K}_{y}\\
...
% Now, following Walker's notation in \cite{walker2016spin}, let us break the dynamics into two components, parallel and perpendicular to the magnetic field $B_0\hat{z}$ $$\mathbf{K}=K_z\hat{z}+\mathbf{K}_{\perp}$$
